"""
Django settings for ninjatech_prd_demo_46883 project.
...
ROOT_URLCONF = 'ninjatech_prd_demo_46883.urls'
...
WSGI_APPLICATION = 'ninjatech_prd_demo_46883.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ninjatech_prd_demo_46883 API",
    "DESCRIPTION": "API documentation for ninjatech_prd_demo_46883 App",
    "VERSION": "v1",
}
